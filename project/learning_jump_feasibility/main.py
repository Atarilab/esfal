...
def main(
    ...
    Args:
        ...
        - run_desc: Name given to the run dir. Usefull to give a short description of the run.
    """
    ### CONFIG
    if cfg != "":
        cfg = Config(cfg)
    ...
    if train:
        ...
        for cfg in sweeper:
            ...
            trainer = trainer(cfg, model, dataloader_train, dataloader_test, run_dir_name=run_desc)
