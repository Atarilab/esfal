...
# From https://colab.research.google.com/drive/1gxdkgRVfM55zihY9TFLja97cSVZOZq2B?usp=sharing#scrollTo=X-XRB_g3vsgf
...
class ConditionalUnet1DBase(nn.Module):
    def __init__(self,
        input_dim,
        global_cond_dim,
    ...
    def forward(self,
        ...
        """
        # (B,T,C)
        noisy_data_samples = noisy_data_samples.moveaxis(-1,-2)
        # (B,C,T)
